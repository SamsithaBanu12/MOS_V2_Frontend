export const commandStateMapping = [
  ...
  {
    command: "OBC_525_TC_GET_TEMP_SNS_CFG",
    telemetry: "OBC_525_TM_GET_TEMP_SNS_CFG",
    states: [
      {
        parameter: "SENSOR_ID",
        states: {
  ...
  {
    command: "OBC_535_TC_GET_PWR_MON_CFG",
    telemetry: "OBC_535_TM_GET_PWR_MON_CFG",
    states: [
      {
        parameter: "SENSOR_ID",
        states: {
    ...
    states: [
      {
        ...
        states: {
          0: 'ENCLOSURE_SURFACE_TEMP',
          1: 'FLEXCORE_TOP_SURFACE',
          2: 'EPS_TOP_SURFACE',
          3: 'BATTERY_PACK_TOP',
          4: 'X_BAND_TX1_HOUSING',
          5: 'X_BAND_TX2_HOUSING',
          6: 'S_BAND_TRX_HOUSING',
          7: 'SIDE_PANEL_RW1',
          8: 'STAR_TRACKER_1',
          9: 'STAR_TRACKER_2',
          10: 'SIDE_PANEL_RW2',
          11: 'CAMERA_ENCLOSURE_INNER',
          12: 'X_BAND_ANTENNA_BRACKET',
          13: 'EXT_STRUCT_SIDE_PANEL_1',
          14: 'EXT_STRUCT_SIDE_PANEL_2',
          15: 'TOP_PLATE_INNER',
          16: 'ALL_CHANNELS_SUMMARY',
        },
      },
    ],
  },
