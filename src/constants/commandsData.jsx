export const commandTelemetryEmulator = [
  ...
  },
  {
    ...
    parameters: [
      "RESET_REASON_1",
      "SOFTWARE_RESET_REASON_1",
      "EPOCH_TIME_1",
      "RESET_REASON_2",
      "SOFTWARE_RESET_REASON_2",
      "EPOCH_TIME_2",
      "RESET_REASON_3",
      "SOFTWARE_RESET_REASON_3",
      "EPOCH_TIME_3",
      "RESET_REASON_4",
      "SOFTWARE_RESET_REASON_4",
      "EPOCH_TIME_4",
      "RESET_REASON_5",
      "SOFTWARE_RESET_REASON_5",
      "EPOCH_TIME_5",
      "RESET_REASON_6",
      "SOFTWARE_RESET_REASON_6",
      "EPOCH_TIME_6",
      "RESET_REASON_7",
      "SOFTWARE_RESET_REASON_7",
      "EPOCH_TIME_7",
      "RESET_REASON_8",
      "SOFTWARE_RESET_REASON_8",
      "EPOCH_TIME_8",
      "RESET_REASON_9",
      "SOFTWARE_RESET_REASON_9",
      "EPOCH_TIME_9",
      "RESET_REASON_10",
      "SOFTWARE_RESET_REASON_10",
      "EPOCH_TIME_10",
      "RESET_REASON_11",
      "SOFTWARE_RESET_REASON_11",
      "EPOCH_TIME_11",
      "RESET_REASON_12",
      "SOFTWARE_RESET_REASON_12",
      "EPOCH_TIME_12",
      "RESET_REASON_13",
      "SOFTWARE_RESET_REASON_13",
      "EPOCH_TIME_13",
      "RESET_REASON_14",
      "SOFTWARE_RESET_REASON_14",
      "EPOCH_TIME_14",
      "RESET_REASON_15",
      "SOFTWARE_RESET_REASON_15",
      "EPOCH_TIME_15",
      "RESET_REASON_16",
      "SOFTWARE_RESET_REASON_16",
      "EPOCH_TIME_16",
      "RESET_REASON_17",
      "SOFTWARE_RESET_REASON_17",
      "EPOCH_TIME_17",
      "RESET_REASON_18",
      "SOFTWARE_RESET_REASON_18",
      "EPOCH_TIME_18",
      "RESET_REASON_19",
      "SOFTWARE_RESET_REASON_19",
      "EPOCH_TIME_19",
      "RESET_REASON_20",
      "SOFTWARE_RESET_REASON_20",
      "EPOCH_TIME_20",
      "RESET_COUNT",
      "ARRAY_INDEX"
    ],
  ...
  },
  {
    ...
    target: "EMULATOR",
    parameters: ["SENSOR_ID", "LOW_TEMP_THRESHOLD", "HIGH_TEMP_THRESHOLD"],
    commandParams: [],
  },
  {
    id: 107,
  ...
  },
  {
    ...
    target: "EMULATOR",
    parameters: ["SENSOR_ID", "LOW_BUS_VOLT_THR", "HIGH_BUS_VOLT_THR", "LOW_CURRENT_THR", "HIGH_CURRENT_THR"],
    commandParams: [],
  },
  {
    id: 109,
    ...
    parameters: [
      ...
      "CHANNEL_ID_1", "RAW_ADC_1", "VOLTAGE_1", "TEMPERATURE_1",
      "CHANNEL_ID_2", "RAW_ADC_2", "VOLTAGE_2", "TEMPERATURE_2",
      "CHANNEL_ID_3", "RAW_ADC_3", "VOLTAGE_3", "TEMPERATURE_3",
      "CHANNEL_ID_4", "RAW_ADC_4", "VOLTAGE_4", "TEMPERATURE_4",
      "CHANNEL_ID_5", "RAW_ADC_5", "VOLTAGE_5", "TEMPERATURE_5",
      "CHANNEL_ID_6", "RAW_ADC_6", "VOLTAGE_6", "TEMPERATURE_6",
      "CHANNEL_ID_7", "RAW_ADC_7", "VOLTAGE_7", "TEMPERATURE_7",
      "CHANNEL_ID_8", "RAW_ADC_8", "VOLTAGE_8", "TEMPERATURE_8",
      "CHANNEL_ID_9", "RAW_ADC_9", "VOLTAGE_9", "TEMPERATURE_9",
      "CHANNEL_ID_10", "RAW_ADC_10", "VOLTAGE_10", "TEMPERATURE_10",
      "CHANNEL_ID_11", "RAW_ADC_11", "VOLTAGE_11", "TEMPERATURE_11",
      "CHANNEL_ID_12", "RAW_ADC_12", "VOLTAGE_12", "TEMPERATURE_12",
      "CHANNEL_ID_13", "RAW_ADC_13", "VOLTAGE_13", "TEMPERATURE_13",
      "CHANNEL_ID_14", "RAW_ADC_14", "VOLTAGE_14", "TEMPERATURE_14",
      "CHANNEL_ID_15", "RAW_ADC_15", "VOLTAGE_15", "TEMPERATURE_15",
      "CHANNEL_ID_16", "RAW_ADC_16", "VOLTAGE_16", "TEMPERATURE_16"
    ],
    commandParams: [],
  },
  {
    id: 110,
    command: "OBC_540_TC_SET_DATA_LOG_CFG",
    telemetry: "OBC_540_TM_SET_DATA_LOG_CFG",
    target: "EMULATOR",
    parameters: ["EXECUTION_STATUS"],
    commandParams: [],
  },
  {
    id: 111,
    command: "OBC_541_TC_GET_DATA_LOG_CFG",
    telemetry: "OBC_541_TM_GET_DATA_LOG_CFG",
    target: "EMULATOR",
    parameters: ["HM_DUMP_PERIODICITY"],
    commandParams: [],
  },
  {
    id: 112,
  ...
  {
    id: 118,
    command: "OBC_626_TC_OTSU_CURRENT_STATUS_INFO",
  ...
  {
    id: 121,
    command: "OBC_635_TC_OTSU_GET_NVM_BINARY_VERSION",
  ...
  {
    id: 123,
    command: "OBC_907_TC_FDIR_SET_HW_OPR_STE",
    telemetry: "OBC_907_TM_FDIR_SET_HW_OPR_STE",
    target: "EMULATOR",
    parameters: [
      "EXECUTION_STATUS",
    ],
  ...
  {
    id: 124,
    command: "OBC_910_TC_FDIR_SET_WRKG_STS_TMR",
    telemetry: "OBC_910_TM_FDIR_SET_WRKG_STS_TMR",
    target: "EMULATOR",
    parameters: [
      "EXECUTION_STATUS",
    ],
