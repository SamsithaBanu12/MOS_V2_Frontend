export const commandTelemetryEmulator = [
  ...
  },
  {
    ...
    commandParams: ["SENSOR_ID", "RESERVED_1", "RESERVED_2", "LOW_TEMP_THRESHOLD", "HIGH_TEMP_THRESHOLD", "RESERVED_3", "RESERVED_4", "RESERVED_5", "RESERVED_6"],
  },
  {
    id: 107,
    ...
    target: "EMULATOR",
    parameters: ["SENSOR_ID", "RESERVED_1", "RESERVED_2", "LOW_TEMP_THRESHOLD", "HIGH_TEMP_THRESHOLD", "RESERVED_3", "RESERVED_4", "RESERVED_5", "RESERVED_6"],
    commandParams: ["SENSOR_ID"],
  },
  {
    id: 108,
    ...
    target: "EMULATOR",
    parameters: ["EXECUTION_STATUS"],
    commandParams: ["SENSOR_ID", "RESERVED_1", "RESERVED_2", "LOW_BUS_VOLT_THR", "HIGH_BUS_VOLT_THR", "LOW_CURRENT_THR", "HIGH_CURRENT_THR", "RESERVED_3", "RESERVED_4", "RESERVED_5", "RESERVED_6"],
  },
  {
    id: 109,
    ...
    target: "EMULATOR",
    parameters: ["SENSOR_ID", "RESERVED_1", "RESERVED_2", "LOW_BUS_VOLT_THR", "HIGH_BUS_VOLT_THR", "LOW_CURRENT_THR", "HIGH_CURRENT_THR", "RESERVED_3", "RESERVED_4", "RESERVED_5", "RESERVED_6"],
    commandParams: ["SENSOR_ID"],
  },
  {
    id: 110,
    ...
    target: "EMULATOR",
    parameters: ["EXECUTION_STATUS", "CHANNEL_ID_1", "RAW_ADC_1", "VOLTAGE_1", "TEMPERATURE_1", "CHANNEL_ID_2", "RAW_ADC_2", "VOLTAGE_2", "TEMPERATURE_2", "CHANNEL_ID_3", "RAW_ADC_3", "VOLTAGE_3", "TEMPERATURE_3", "CHANNEL_ID_4", "RAW_ADC_4", "VOLTAGE_4", "TEMPERATURE_4", "CHANNEL_ID_5", "RAW_ADC_5", "VOLTAGE_5", "TEMPERATURE_5", "CHANNEL_ID_6", "RAW_ADC_6", "VOLTAGE_6", "TEMPERATURE_6", "CHANNEL_ID_7", "RAW_ADC_7", "VOLTAGE_7", "TEMPERATURE_7", "CHANNEL_ID_8", "RAW_ADC_8", "VOLTAGE_8", "TEMPERATURE_8", "CHANNEL_ID_9", "RAW_ADC_9", "VOLTAGE_9", "TEMPERATURE_9", "CHANNEL_ID_10", "RAW_ADC_10", "VOLTAGE_10", "TEMPERATURE_10", "CHANNEL_ID_11", "RAW_ADC_11", "VOLTAGE_11", "TEMPERATURE_11", "CHANNEL_ID_12", "RAW_ADC_12", "VOLTAGE_12", "TEMPERATURE_12", "CHANNEL_ID_13", "RAW_ADC_13", "VOLTAGE_13", "TEMPERATURE_13", "CHANNEL_ID_14", "RAW_ADC_14", "VOLTAGE_14", "TEMPERATURE_14", "CHANNEL_ID_15", "RAW_ADC_15", "VOLTAGE_15", "TEMPERATURE_15", "CHANNEL_ID_16", "RAW_ADC_16", "VOLTAGE_16", "TEMPERATURE_16"],
    commandParams: ["CHANNEL_ID"],
  },
  {
    id: 111,
    ...
    target: "EMULATOR",
    parameters: ["GNSS_YEAR", "GNSS_MONTH", "GNSS_DATE", "GNSS_HOUR", "GNSS_MINUTE", "GNSS_MILLISEC", "GNSS_EPOCH_TIME", "GNSS_SOLUTION_STATUS", "GNSS_POSITION_TYPE", "LATITUDE", "LONGITUDE", "HEIGHT", "UNDULATION", "DATUM_ID", "STD_LATITUDE", "STD_LONGITUDE", "STD_HEIGHT", "STATION_ID", "DIFFERENTIAL_AGE", "SOLUTION_AGE", "SAT_TRACKED", "SAT_USED", "EXT_SOLUTION_STATUS"],
    commandParams: [],
  },
  {
    id: 112,
  ...
  {
    id: 113,
    command: "OBC_957_TC_SYNC_GPS_TIME",
    telemetry: "OBC_957_TM_SYNC_GPS_TIME",
    target: "EMULATOR",
    parameters: ["HOUR", "MINUTE", "MILLI_SECONDS", "DATE", "MONTH", "YEAR"],
    commandParams: [],
  },
  {
    id: 114,
    command: "OBC_951_TC_GPS_GET_3D_POSITION_VELOCITY",
    telemetry: "OBC_951_TM_GPS_GET_3D_POSITION_VELOCITY",
    target: "EMULATOR",
    parameters: [
      "YEAR",
      "MONTH",
  ...
  },
  {
    ...
    target: "EMULATOR",
    parameters: ["FW_UPDATE_STATUS"],
    commandParams: ["INTERNAL_FLAG", "FW_PATCH_VER", "FW_MINOR_VER", "FW_MAJOR_VER", "FW_ARCHI_VER", "GS_CONTACT_TIMEOUT", "OBC_FORCE_SHUTDOWN_TIMEOUT"],
  },
  {
    id: 119,
    ...
    target: "EMULATOR",
    parameters: [
      "BOOT_ACTIVATION_STATUS",
      "FW_PATCH_VER",
      "FW_MINOR_VER",
      "FW_MAJOR_VER",
      "FW_ARCHI_VER",
      "GS_CONTACT_TIMEOUT",
      "OBC_FORCE_SHUTDOWN_TIMEOUT"
    ],
    commandParams: [],
  },
  {
    id: 120,
    command: "OBC_635_TM_OTSU_GET_NVM_FW_VERSION",
    telemetry: "OBC_635_TM_OTSU_GET_NVM_FW_VERSION",
    target: "EMULATOR",
    parameters: [
      "NVM_INTEGRITY_STATUS",
      "NVM_MAJOR_VERSION",
      "NVM_MINOR_VERSION",
      "NVM_DEFAULT_VALUE"
    ],
    commandParams: ["NVM_VERSION_REQ"],
  },
  {
    id: 121,
    ...
    parameters: [
      ...
      "EEPROM1_WRITE_COUNT",
      "EEPROM2_WRITE_COUNT",
      "EEPROM1_WRITE_COUNT_POST_BOOT",
      "EEPROM2_WRITE_COUNT_POST_BOOT"
    ],
    commandParams: [],
  },
];