...
import { humanFromEpoch, isUserAccessible } from "../../utils/utils";
        ...
        <>
          <div className="su-card" style={{ flex: 1 }}>
            <div className="su-card-header">
              ...
              <button
                className={`su-btn ${baseEntries.length === 0 || !isUserAccessible() ? 'su-btn-small-disabled' : 'su-btn-small'}`}
                type="button"
                onClick={() => setIsEditing((v) => !v)}
                disabled={baseEntries.length === 0 || !isUserAccessible()}
              >
            ...
            <div className="su-button-row" style={{ marginTop: 10 }}>
              <button
                className={`su-btn ${loadingGenerate || !isUserAccessible() ? "su-btn-primary-disabled" : "su-btn-primary"}`}
                type="button"
                onClick={handleGenerate}
                disabled={loadingGenerate || !isUserAccessible()}
              >
          ...
          <div className="su-button-secondary-wrapper">
            <button
              ...
              disabled={!generatedFilename || loadingUpload || !isUserAccessible()}
            >
              {loadingUpload
                ? "Uploading & running…"
